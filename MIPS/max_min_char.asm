# MIPS Program for calculating the maximum & minimum
# Of ASCI values from given two string
# @input  -> NAME_BUFF (50 bytes long)
# @output -> (1) MAX ascii value with the char
#	     (2) MIN ascii value with the char
.data
